...
//   明文化した。第 11 条は入り口だけを示し、実体の条件はプライバシーポリシー第 4 条に置く
//   (規約とポリシーで同じ規律を二重管理して食い違わせないため)。
//   - 権利帰属は従前どおりユーザー。譲渡させない (「移転しません」を明記)。
//   - raw user content の他ユーザーへの提供は禁止のまま。許すのは集計・一般化された知見のみ。
//   - 個別事例の紹介は別途の明示同意を要する旨を分離 (統計利用に含めない)。
//   - AI 基盤モデルの学習提供・データ販売・広告目的提供は行わない旨を明記 (権限拡大ではなく制限)。
//   ★ 料金・解約・特商法まわりの条項は本改定の対象外 (第 4 / 5 条は一切変更していない)。
//
// 構成:
        ...
        <div className="space-y-8">
          ...
          <LegalArticle number={11} title="知的財産権">
            <ol className="list-decimal pl-5 space-y-1.5">
              ...
              <li>
                前項のデータに関する権利は当サービスへ移転しません。ユーザーは、当サービス
                が以下の目的の達成に必要な範囲に限り、ユーザーが入力したデータを利用する
                ことを許諾するものとします (非独占的な利用許諾であり、以下の目的を超えて
                利用することはありません)。
                <ul className="list-disc pl-5 mt-1 space-y-0.5 text-slate-600">
                  <li>本サービスの提供および運用</li>
                  <li>保守、障害対応、および安全性・セキュリティの確保</li>
                  <li>不正利用および本規約違反の検出と防止</li>
                  <li>
                    本サービスの品質改善 (AI による回答・添削・フィードバックの品質改善、
                    画面や機能の改善を含みます)
                  </li>
                  <li>
                    統計・傾向情報の作成および分析 (次項)
              ...
              <li>
                当サービスは、ユーザーが入力した内容そのものや、ユーザー個人を特定できる
                情報を、他のユーザーへ提供・表示しません。一方で、複数のユーザーの利用から
                得られた情報を、特定の個人を識別できないように集計・一般化したうえで、
                本サービスの改善および他のユーザーへの一般的な傾向情報・助言の提供に利用
                することがあります。その具体的な範囲および安全のための措置は{' '}
              ...
              <li>
                特定のユーザーの回答例、エントリーシート、選考結果等を個別の事例として
                他のユーザーへ提供し、または紹介する場合には、その都度ご本人から明示的な
                同意をいただきます。前項の統計・傾向情報の利用は、これを含みません。
              </li>
              <li>
                当サービスは、ユーザーが入力した内容を、当サービスまたは第三者による AI
                基盤モデルの学習 (トレーニング) 用データとして提供しません。また、ユーザー
                の情報を第三者へ販売し、または広告配信・マーケティングの目的で第三者へ提供
                することはありません。
              </li>
              <li>
              ...
              <li>
                ユーザーの個人情報およびユーザーが入力した情報の取扱いの詳細は、{' '}
                <Link href="/privacy" className="text-brand-700 hover:underline">
                  プライバシーポリシー
                </Link>{' '}
                の定めによります。本条とプライバシーポリシーの内容に齟齬がある場合は、
                個人情報の取扱いについてはプライバシーポリシーが優先します。
              </li>
            </ol>
          </LegalArticle>
